...
public class BufferPoolsExports extends Collector {
    ...
    public BufferPoolsExports(Map<String, String> globalLabelsMap) {
        try {
    ...
    public List<MetricFamilySamples> collect() {
        ...
        GaugeMetricFamily used = new GaugeMetricFamily(
                ...
                listCloneAndAdd(this.globalLabelNames,"pool"));
        mfs.add(used);
        ...
        for (final Object pool : bufferPoolMXBeans) {
            used.addMetric(
                    listCloneAndAdd(this.globalLabelValues, getName(pool)),
